...
import { GET_TOPICS_PUBLICLY } from '../../../src/graphql/query/topic';
import {
  FilterTopicProps,
  SearchResultObj,
        ...
        {data && data.rows.length > 0 && (
          <>
            <div className="listContainer">
              <TopicList data={data.rows} isLogin={false} />
            </div>
            <ReactPaginate
...
Topics.getInitialProps = async ctx => {
  try {
    ...
    return {
      data: _.get(data, 'filterTopicsPublicly', new SearchResultObj()),
      loading,
      pageNum,
      pageSize,
    };
